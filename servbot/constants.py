...
# DEPRECATED: Flashmail Graph API credentials are per-account and MUST NOT be hard-coded.
# Keep these names for backward compatibility, but they are intentionally empty.
FLASHMAIL_REFRESH_TOKEN = ""
FLASHMAIL_CLIENT_ID = ""

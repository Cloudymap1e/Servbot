...
class TestCompleteEmailFlow(unittest.TestCase):
    ...
    def test_01_provision_account_mock(self):
        ...
        with patch('servbot.clients.flashmail._http_get') as mock_http:
            ...
            print(f"✓ Provisioned account: {accounts[0].email}")
            print(f"✓ Password: {accounts[0].password}")
            print(f"✓ Source: {accounts[0].source}")
        ...
        with patch('servbot.clients.imap.IMAPClient') as MockIMAPClient:
            ...
            for v in verifications:
                if self.test_code in v.code:
                    ...
                    print(f"✓ Found verification code: {v.code}")
                    print(f"✓ Service identified: {v.service}")
        ...
        with patch('servbot.clients.imap.IMAPClient') as MockIMAPClient:
            ...
            for v in verifications:
                if self.test_link in v.code:
                    ...
                    print(f"✓ Found verification link: {v.code}")
                    print(f"✓ Service identified: {v.service}")
                    break
    ...
    def test_04_database_storage(self):
        ...
        print(f"✓ Saved verification ID: {verification_id}")
        ...
        for v in verifications:
            if v['value'] == test_code_db and v['service'] == test_service_db:
                ...
                print(f"✓ Retrieved verification: {v['service']} = {v['value']}")
                break
    ...
    def test_06_poll_for_verification(self):
        ...
        with patch('servbot.clients.imap.IMAPClient') as MockIMAPClient:
            ...
            print(f"✓ Successfully polled and found code: {code}")
            print(f"✓ Took {call_count[0]} polling attempts")
...
class TestFlashmailAPIEndpoints(unittest.TestCase):
    ...
    def test_inventory_endpoint(self):
        ...
        with patch('servbot.clients.flashmail._http_get') as mock_http:
            ...
            print(f"✓ Hotmail available: {inventory['hotmail']}")
            print(f"✓ Outlook available: {inventory['outlook']}")
